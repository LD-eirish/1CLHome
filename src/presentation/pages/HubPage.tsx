      ...
      <main className="container">
        <div className="hub-masthead">
          <div className="hub-masthead-text">
            <h2 className="hub-masthead-title">1st Combined Legion</h2>
            <p className="hub-masthead-sub">Central Hub for 1CL Info</p>
            <a
          ...
          <div className="hub-masthead-seal">
            <img src={assetPath('1CLLogo.png')} alt="1CL" className="hub-seal-img" />
          </div>
        </div>
