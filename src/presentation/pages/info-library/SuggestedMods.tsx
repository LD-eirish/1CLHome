...
const MOD_SECTIONS: ModSection[] = [
  {
    ...
    intro:
      "Mods that we recommend for the best experience for casual Foxhole players.",
    mods: [
      {
  ...
  return (
    ...
    >
      <section className="wiki-section" id="suggested-mods-overview">
        ...
        <p>
          The mods listed below are recommended for enhancing your gameplay
          experience in Foxhole. They provide various improvements, from visual
          enhancements to sound overhauls, and can help make your time in the
          game more enjoyable and immersive.
        </p>
        <p>
          Please note that while these mods are suggested, they are not
          officially endorsed by the game developers. Always ensure that you
          download mods from trusted sources and follow any installation
          instructions provided by the mod creators.
        </p>
      </section>
      <section className="wiki-section" id="how-to-install-mods">
        <h2 className="wiki-section-heading">How to install mods in Foxhole</h2>
        <p>
          To install mods in Foxhole, you typically need to download the mod
          files from the mod's official page and place them in the appropriate
          directory within your Foxhole installation folder. The exact location
          of your game files differs based on your operating system and where
          you installed the game.
        </p>
        <p>
          On Windows, the default installation path is usually:{" "}
          <code className="mod-path">
            [YOUR DRIVE]:\SteamLibrary\steamapps\common\Foxhole
          </code>
        </p>
        <p>
          From your Foxhole installation folder, you will need to go to the{" "}
          <code className="mod-path">\War\Content\Paks</code> directory.
        </p>
        <p>
          In the <code className="mod-path">Paks</code> directory, you will need to extract the
          downloaded mod files. It will typically be a <code className="mod-path">.pak</code> file
          that you will be placed in this directory.
        </p>
        <p>
          After placing the mod files in the correct directory, you will need to
          restart the game for the changes to take effect.
        </p>
        <p>
          Below you will find an example image of how your <code className="mod-path">Paks</code>{" "}
          directory should look after installing mods. The <code className="mod-path">.pak</code>{" "}
          files for the mods should be present alongside the{" "}
