    ...
    >
      <div className="modal-content regiment-modal">
        ...
        <div className="modal-body">
          ...
          <section className="modal-section">
            <h3>Details</h3>
            <dl className="modal-details-list">
              <dt>Joined:</dt>
              <dd>
              ...
              <dt>Leader:</dt>
              <dd>{regiment.leader ?? 'TBD'}</dd>

              {regiment.activityTime && (
                <>
                  <dt>Peak Activity:</dt>
                  <dd>{formatActivityTime(regiment.activityTime, false)}</dd>
                </>
              )}
...
export const RegimentModal = memo(RegimentModalComponent);
